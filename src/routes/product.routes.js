 ...
 */
// Compartido con utils/stock.js, que lo vuelve a aplicar cada vez que una
// venta o cancelación cambia la cantidad de una variante.
const { deriveParentPricingFromVariations } = require('../utils/parentPricing');
